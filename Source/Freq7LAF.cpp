...
void Freq7LAF::drawLinearSlider (juce::Graphics& g, int x, int y, int width, int height,
                       float sliderPos,
                       float minSliderPos,
                       float maxSliderPos,
...

{
    ...
    g.setColour (juce::Colours::ghostwhite.darker(0.075f));
    g.strokePath (backgroundTrack, { trackWidthFrequencyBackground7, juce::PathStrokeType::curved, juce::PathStrokeType::rounded });
    
    //==============================================================================
                                            //Creates Track for Slider
    //==============================================================================
    
    auto trackWidthFrequency7 = juce::jmin (8.5f, (float) height );
    ...
    g.strokePath (track, { trackWidthFrequency7, juce::PathStrokeType::curved, juce::PathStrokeType::rounded });
