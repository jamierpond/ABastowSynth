/*
  ==============================================================================
    ...
    Oscillator1.h
    Created: 19 Mar 2022 12:13:51am
    Author:  Bastow_boii 1
 ==============================================================================
                                Description
 
 Inherits from WaveGeneratorVoice.
 Oscilator 1, creates sine wave adds it to the audio buffer.
  ==============================================================================
*/
//                              References
///                          (David-Badiane, 2020)
...
public:
    ...
    void startNote(int midiNoteNumber, float velocity, juce::SynthesiserSound*, int) override{
        ...
        angleDelta = inc * 2.0 * juce::MathConstants<double>::pi;
...
private :
    void processBlock(juce::AudioBuffer<float>& outputBuffer, int startSample, int numSamples)
    {
        ...
        while (--numSamples >= 0)
        {
            ...
            auto SliderAudio = level  * originalGain ;
            auto GainAudio = std::sin(currentAngle) * SliderAudio;
