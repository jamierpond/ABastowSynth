...
void Gain8LAF::drawLinearSlider  (juce::Graphics& g, int x, int y, int width, int height,
                       float sliderPos,
                       float minSliderPos,
                       float maxSliderPos,
...

{
    ...
    auto trackWidthGainBackground8 = juce::jmin (15.5f, (float) height  );
    ...
    g.strokePath (backgroundTrack, { trackWidthGainBackground8, juce::PathStrokeType::curved, juce::PathStrokeType::rounded });
    
    //==============================================================================
                                            //Creates Track for Slider
    //==============================================================================
    
    auto trackWidthGain8 = juce::jmin (6.5f, (float) height );
    ...
    g.setColour (violet.darker(0.32));
   
    g.strokePath (track, { trackWidthGain8, juce::PathStrokeType::curved, juce::PathStrokeType::rounded });
...
int thumbBeingDragged = slider.getThumbBeingDragged();
    ...
    g.setColour (violet.darker(0.64f));
