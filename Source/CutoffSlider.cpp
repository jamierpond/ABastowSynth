...
CutoffSliderLAF::CutoffSliderLAF(){};
CutoffSliderLAF::~CutoffSliderLAF(){};


juce::Slider::SliderLayout CutoffSliderLAF::getSliderLayout (juce::Slider& slider)
{
...
void CutoffSliderLAF::drawRotarySlider (juce::Graphics& g, int x, int y, int width, int height, float sliderPos,
                                          const float rotaryStartAngle, const float rotaryEndAngle, juce::Slider& slider)
{
    ...
    g.setColour (red.brighter(0.75f));;
    ...
    g.setColour (red.brighter(0.75f));
    juce::Path redCover1;
    redCover1.addCentredArc (bounds.getCentreX(),
                                 bounds.getCentreY(),
                                 arcRadius,
                                 arcRadius,
                                 0.0f,
    ...
    g.setColour (juce::Colours::red.darker(0.175f));
    g.strokePath (redCover1, juce::PathStrokeType (smallLine, juce::PathStrokeType::curved, juce::PathStrokeType::rounded));
    
    g.setColour (juce::Colours::red.brighter(0.75f));
    juce::Path redCover2;
    redCover2.addCentredArc (bounds.getCentreX(),
                                 bounds.getCentreY(),
                                 arcRadius,
                                 arcRadius,
                                 0.0f,
    ...
    g.setColour (juce::Colours::red.darker(0.175f));
    g.strokePath (redCover2, juce::PathStrokeType (smallLine, juce::PathStrokeType::curved, juce::PathStrokeType::rounded));
