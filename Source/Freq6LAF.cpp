...
void Freq6LAF::drawLinearSlider (juce::Graphics& g, int x, int y, int width, int height,
                       float sliderPos,
                       float minSliderPos,
                       float maxSliderPos,
...

{
    ...
    auto trackWidthFrequencyBackground6 = juce::jmin (19.5f, (float) height * 10.f );
    ...
    g.setColour (juce::Colours::ghostwhite.darker(0.075f));
    g.strokePath (backgroundTrack, { trackWidthFrequencyBackground6, juce::PathStrokeType::curved, juce::PathStrokeType::rounded });
    
    //==============================================================================
                                            //Creates Track for Slider
    //==============================================================================
    
    auto trackWidthFrequency6 = juce::jmin (8.5f, (float) height );
    ...
    g.setColour (brightBlue);
   
    g.strokePath (track, { trackWidthFrequency6, juce::PathStrokeType::curved, juce::PathStrokeType::rounded });
...
int thumbBeingDragged = slider.getThumbBeingDragged();
    ...
    g.setColour (brightBlue.darker(0.08f));
                                    g.drawRoundedRectangle (juce::Rectangle<float> (static_cast<float> (x ? maxThumbWidth : minThumbWidth),
                                                                                    static_cast<float> (x ? maxThumbWidth : minThumbWidth))
