...
void Gain7LAF::drawLinearSlider  (juce::Graphics& g, int x, int y, int width, int height,
                       float sliderPos,
                       float minSliderPos,
                       float maxSliderPos,
...
g.strokePath (backgroundTrack, { trackWidthGainBackground7, juce::PathStrokeType::curved, juce::PathStrokeType::rounded });

//==============================================================================
    //Creates Track for Slider
//==============================================================================

auto trackWidthGain7 = juce::jmin (6.5f, (float) height );
...
track.lineTo (endPoint);
    ...
    g.setColour (blue.darker(0.32f));

g.strokePath (track, { trackWidthGain7, juce::PathStrokeType::curved, juce::PathStrokeType::rounded });
...
g.drawRoundedRectangle (juce::Rectangle<float> (static_cast<float> (x ? maxThumbWidth : minThumbWidth),
                                            ...
                                            .withCentre (x ? startPoint : minPoint), 325, 6.f);
