...
#include "Gain5.h"
    ...
    void Gain5LAF::drawLinearSlider  (juce::Graphics& g, int x, int y, int width, int height,
                           float sliderPos,
                           float minSliderPos,
                           float maxSliderPos,
    ...
    auto trackWidthGainBackground5 = juce::jmin (15.5f, (float) height  );
    ...
    g.strokePath (backgroundTrack, { trackWidthGainBackground5, juce::PathStrokeType::curved, juce::PathStrokeType::rounded });
        
    //==============================================================================
        //Creates Track for Slider
    //==============================================================================

    auto trackWidthGain5 = juce::jmin (6.5f, (float) height );
    ...
    track.lineTo (endPoint);
        ...
        g.setColour (limeGreen.darker(0.32f));;

    g.strokePath (track, { trackWidthGain5, juce::PathStrokeType::curved, juce::PathStrokeType::rounded });
    ...
    //==============================================================================
        ...
        g.setColour (limeGreen.darker(0.64f));
    ...
    g.drawRoundedRectangle (juce::Rectangle<float>(static_cast<float> (maxThumbWidth), static_cast<float> (maxThumbWidth)).withCentre (maxPoint), 0, 0.01);
