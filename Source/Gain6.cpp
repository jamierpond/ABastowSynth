...
void Gain6LAF::drawLinearSlider  (juce::Graphics& g, int x, int y, int width, int height,
                       float sliderPos,
                       float minSliderPos,
                       float maxSliderPos,
...
auto trackWidthGainBackground6 = juce::jmin (15.5f, (float) height  );
...
g.strokePath (backgroundTrack, { trackWidthGainBackground6, juce::PathStrokeType::curved, juce::PathStrokeType::rounded });

//==============================================================================
    //Creates Track for Slider
//==============================================================================
    
auto trackWidthGain6 = juce::jmin (7.5f, (float) height );
...
track.lineTo (endPoint);
    ...
    g.setColour (brightBlue.darker(0.32f));

g.strokePath (track, { trackWidthGain6, juce::PathStrokeType::curved, juce::PathStrokeType::rounded });
...
//==============================================================================
    g.setColour (brightBlue.darker(0.64f));
...
g.drawRoundedRectangle (juce::Rectangle<float>(static_cast<float> (maxThumbWidth), static_cast<float> (maxThumbWidth)).withCentre (maxPoint), 1, 0.1);
