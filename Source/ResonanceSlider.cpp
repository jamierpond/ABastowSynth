...
ResonanceSliderLAF::ResonanceSliderLAF(){};
ResonanceSliderLAF::~ResonanceSliderLAF(){};


juce::Slider::SliderLayout ResonanceSliderLAF::getSliderLayout (juce::Slider& slider)
{
...
void ResonanceSliderLAF::drawRotarySlider (juce::Graphics& g, int x, int y, int width, int height, float sliderPos,
                                          const float rotaryStartAngle, const float rotaryEndAngle, juce::Slider& slider)
{
    ...
    g.setColour (green.darker(0.075f));
    ...
    g.setColour (green.brighter(0.75f));;
    ...
    //==============================================================================
                                //Red Covers
    //==============================================================================
    g.setColour (green.brighter(0.075f));
    juce::Path greenCover1;
    greenCover1.addCentredArc (bounds.getCentreX(),
                                 bounds.getCentreY(),
                                 arcRadius,
                                 arcRadius,
                                 0.0f,
    ...
    g.setColour (green.darker(0.075f));
    g.strokePath (greenCover1, juce::PathStrokeType (smallLine, juce::PathStrokeType::curved, juce::PathStrokeType::rounded));
    
    g.setColour (green.brighter(0.075f));
    juce::Path greenCover2;
    greenCover2.addCentredArc (bounds.getCentreX(),
                                 bounds.getCentreY(),
                                 arcRadius,
                                 arcRadius,
                                 0.0f,
    ...
    g.setColour (green.darker(0.075f));
    g.strokePath (greenCover2, juce::PathStrokeType (smallLine, juce::PathStrokeType::curved, juce::PathStrokeType::rounded));
