...
void Freq2LAF::drawLinearSlider (juce::Graphics& g, int x, int y, int width, int height,
                       float sliderPos,
                       float minSliderPos,
                       float maxSliderPos,
...

{
    ...
    auto trackWidthFrequencyBackground2 = juce::jmin (19.5f, (float) height * 10.f );
    ...
    g.setColour (juce::Colours::ghostwhite.darker(0.075f));
    g.strokePath (backgroundTrack, { trackWidthFrequencyBackground2, juce::PathStrokeType::curved, juce::PathStrokeType::rounded });
    
    //==============================================================================
                                            //Creates Track for Slider
    //==============================================================================
    
    auto trackWidthFrequency2 = juce::jmin (8.5f, (float) height );
    ...
    g.strokePath (track, { trackWidthFrequency2, juce::PathStrokeType::curved, juce::PathStrokeType::rounded });
...
int thumbBeingDragged = slider.getThumbBeingDragged();
    ...
    g.setColour (orange.darker(0.08f));
                                    g.drawRoundedRectangle (juce::Rectangle<float> (static_cast<float> (x ? maxThumbWidth : minThumbWidth),
                                                                                    static_cast<float> (x ? maxThumbWidth : minThumbWidth))
