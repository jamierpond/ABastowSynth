...
SustainSliderLAF::SustainSliderLAF(){};
SustainSliderLAF::~SustainSliderLAF(){};


juce::Slider::SliderLayout SustainSliderLAF::getSliderLayout (juce::Slider& slider)
{
...
void SustainSliderLAF::drawRotarySlider (juce::Graphics& g, int x, int y, int width, int height, float sliderPos,
                                          const float rotaryStartAngle, const float rotaryEndAngle, juce::Slider& slider)
{
    ...
    g.setColour (blue.darker(0.075f));
    ...
    g.setColour (blue.brighter(0.75f));;
    ...
    //==============================================================================
                                //Red Covers
    //==============================================================================
    g.setColour (blue.brighter(0.075f));
    juce::Path blueCover1;
    blueCover1.addCentredArc (bounds.getCentreX(),
                                 bounds.getCentreY(),
                                 arcRadius,
                                 arcRadius,
                                 0.0f,
    ...
    g.setColour (blue.darker(0.075f));
    g.strokePath (blueCover1, juce::PathStrokeType (smallLine, juce::PathStrokeType::curved, juce::PathStrokeType::rounded));
    
    g.setColour (blue.brighter(0.075f));
    juce::Path blueCover2;
    blueCover2.addCentredArc (bounds.getCentreX(),
                                 bounds.getCentreY(),
                                 arcRadius,
                                 arcRadius,
                                 0.0f,
    ...
    g.setColour (blue.darker(0.075f));
    g.strokePath (blueCover2, juce::PathStrokeType (smallLine, juce::PathStrokeType::curved, juce::PathStrokeType::rounded));
