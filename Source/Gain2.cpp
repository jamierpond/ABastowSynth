...
void Gain2LAF::drawLinearSlider  (juce::Graphics& g, int x, int y, int width, int height,
                       float sliderPos,
                       float minSliderPos,
                       float maxSliderPos,
...

{
    ...
    auto trackWidthGainBackground2 = juce::jmin (15.5f, (float) height  );
    ...
    g.strokePath (backgroundTrack, { trackWidthGainBackground2, juce::PathStrokeType::curved, juce::PathStrokeType::rounded });
    
    //==============================================================================
                                            //Creates Track for Slider
    //==============================================================================
    
    auto trackWidthGain2 = juce::jmin (6.5f, (float) height );
    ...
    g.setColour (orange.darker(0.32f));
   
    g.strokePath (track, { trackWidthGain2, juce::PathStrokeType::curved, juce::PathStrokeType::rounded });
    ...
    g.setColour (offWhite.brighter(5.5f));
                                    g.drawRoundedRectangle (juce::Rectangle<float> (static_cast<float> (x ? maxThumbWidth : minThumbWidth),
                                                                                    ...
                                                                                    .withCentre (x ? startPoint : minPoint), 325, 5);
...
int thumbBeingDragged = slider.getThumbBeingDragged();
    ...
    g.setColour (orange.darker(0.64f));
