...
AttackSliderLAF::AttackSliderLAF(){};
AttackSliderLAF::~AttackSliderLAF(){};


juce::Slider::SliderLayout AttackSliderLAF::getSliderLayout (juce::Slider& slider)
{
...
void AttackSliderLAF::drawRotarySlider (juce::Graphics& g, int x, int y, int width, int height, float sliderPos,
                                          const float rotaryStartAngle, const float rotaryEndAngle, juce::Slider& slider)
{
    ...
    g.setColour (yellow.darker(0.075f));
    ...
    g.setColour (yellow.brighter(0.75f));;
    ...
    //==============================================================================
                                //Red Covers
    //==============================================================================
    g.setColour (yellow.brighter(0.075f));
